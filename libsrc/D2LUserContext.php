...
class D2LUserContext implements ID2LUserContext {
    ...
    public function createAuthenticatedUri($path, $httpMethod) {
        ...
        $uriScheme = $this->GetUriScheme(); //https
    ...
    private function getQueryString($path, $httpMethod) {
		...
		// GET&/d2l/api/lp/1.0/users/whoami&1414521795
    ...
    private function formatSignature($path, $httpMethod, $timestampSeconds) {
        return strtoupper($httpMethod) . '&' . strtolower($path) . '&' . $timestampSeconds;
    }
	...
	//?x_a=pWh5kx9jSWib_aYrxP_fNg&x_b=lRmslpZ9P-NNPy7iSoMq3e&x_c=34i934i9354i3q2_xd=34934iadfa3aeo
